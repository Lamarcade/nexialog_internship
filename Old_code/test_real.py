...
risks, returns, sharpes = pf.efficient_frontier(method = 2, max_risk_tol = 0.5, max_std = 0.08)
...
risks_rf, returns_rf, _ = pf.efficient_frontier(method = 2, max_risk_tol = 0.5, max_std = 0.08)
...
risks_ns, returns_ns, _ = pf.efficient_frontier(method = 2, max_risk_tol = 0.5, max_std = 0.08)
