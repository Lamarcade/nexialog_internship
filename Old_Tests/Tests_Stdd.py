# -*- coding: utf-8 -*-
"""
Created on Wed May 29 18:31:05 2024
...
# Worst score approach
ESGTV5, all_ranks = SG.worst_score(scores_ranks, n_classes = 7, get_all = True)
ESGTV6 = SG.worst_score(scores_ranks, n_classes = 7, reverse = True)

ESGTV7 = pd.DataFrame({'Tag': ESGTV3['Tag'], 'Score': round(all_ranks.mean(axis = 1)).astype(int)})
...
agencies_df_list = [std_ESGTV3, std_ESGTV4, std_ESGTV5, std_ESGTV6, std_ESGTV7]
#agencies_df_list = []
