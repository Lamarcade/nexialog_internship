...
def cluster_hierarchical(score_df = triplet, indices = valid_indices, n_classes = 7):
...
def kmeans(score_df = triplet, indices = valid_indices, n_classes = 7):
...
def classify_gaussian_mixture(score_df = triplet, indices = valid_indices, n_classes = 7, class_proportions = class_proportions, n_mix = 50):
